...
import FooterCssvnknw from "../components/food/FooterCssvnknw";
import FrameComponent1 from "../components/food/FrameComponent1";
import DishItems1 from "../components/food/DishItems1";
import DishItems from "../components/food/DishItems";
import DivChakrastack from "../components/food/DivChakrastack";
import RightContent from "../components/food/RightContent";
import styles from "./KashmiriPanditCuisine.module.css";

const KashmiriPanditCuisine = () => {
  return (
    <div className={styles.kashmiriPanditCuisine}>
      ...
      <main className={styles.content}>
        <section className={styles.cuisineTitleParent}>
          <div className={styles.cuisineTitle}>
            <h1 className={styles.kashmiriPanditCuisine1}>
          ...
          <div className={styles.divCsslnsa}>
            <FooterCssvnknw
              ...
              theDishWasOriginallyBroug="The dish was originally brought to Kashmir by the Mughals, whose cuisine was, in turn, influenced by Persian cuisine."
            />
            <div className={styles.icon}>
              <div className={styles.dumAlooParent}>
                ...
                <div className={styles.dumAlooIs}>
                  ...
                  traditional Kashmiri Pandit cuisine, from the Kashmir Valley.
                  It was created by the end of the 18th century. 
                </div>
              </div>
              <img
                className={styles.pgpgpgIcon}
                alt=""
            ...
            <FooterCssvnknw
              ...
              theDishWasOriginallyBroug="Nadru can be cooked in many ways: one of the most common is Nadru Yakhni (cooked using yogurt)."
            />
            <FrameComponent1
              kANNGUCCH="KANNGUCCH"
              ...
              <div className={styles.kahwahParent}>
                ...
                <div className={styles.theKashmiriKahwahContainer}>
                  <p className={styles.theKashmiriKahwah}>
                    ...
                    local saffron, cinnamon, cardamom and occasionally Kashmiri
                  ...
                  <p className={styles.traditionallyKahwahIs}>
                    Traditionally, kahwah is prepared in a copper kettle known
                    as a samavar. A samovar, which originates from Russia,
                    consists of a fire container, in which live coals are placed
                    to keep the tea warm. Around the fire container there is a
                    space for water to boil and the tea leaves and other
                    ingredients are mixed with the water.
                  </p>
                  <p className={styles.blankLine1}>&nbsp;</p>
                  <p className={styles.whileItsExact}>
                    While its exact origins are unclear, kahwah tea leaves are
                    said to have come to Kashmir through the Spice Route (which
                    Kashmir was a central point of). Many believe that it
                    originated during the Kushan empire in the first and second
                    century AD.
                  </p>
                  <p className={styles.blankLine2}>&nbsp;</p>
                  <p className={styles.theWordKahwah}>
                    The word Kahwah in Kashmiri means "sweetened tea", the word
                    also seems to be related to the Turkish word for coffee
                    (kahveh) which in turn might be derived from the Arabic word
                    "qahwah."
                  </p>
                </div>
              </div>
            ...
            <FooterCssvnknw
              ...
              theDishWasOriginallyBroug="This is served frequently during weddings, festivals, and gatherings "
            />
              ...
              <div className={styles.divCsseoey}>
                ...
                <div className={styles.yakhniCameToContainer}>
                  <p className={styles.yakhniCameTo}>
                    ...
                    Yoghurt-based meat curries were common in Persian cuisine.
                    The Emperor introduced this style of cooking to his new
                    state when he annexed it in 1586.
                  </p>
                  <p className={styles.blankLine3}>&nbsp;</p>
                  <p className={styles.yakhnisCanBeMeatBasedSuch}>
                    <span>{`Yakhnis can be meat based such as meat yakhni or it can be used as a preparation method for vegetable dishes too such as `}</span>
                    <i className={styles.nadruYakhni}>Nadru Yakhni</i>
                    <span className={styles.and}>{` and `}</span>
                    <i className={styles.alYakhni}>Al Yakhni</i>
                    <span className={styles.span}>.</span>
                  </p>
                </div>
              </div>
              <img
                className={styles.divCssqlraIcon}
                alt=""
            ...
            <div className={styles.dishItems}>
              <div className={styles.katlamParent}>
                ...
                <div className={styles.katlamIsOneContainer}>
                  ...
                  <p className={styles.itIsAFlakyRoundPattyLik}>
                    <span>{`It is a flaky round, patty like bread, typically eaten as an evening snack with either sheer chai or `}</span>
                    <i className={styles.kahwah1}>kahwah.</i>
                  </p>
                </div>
              </div>
              <img
                className={styles.dishItemsChild}
                alt=""
...
export default KashmiriPanditCuisine;
